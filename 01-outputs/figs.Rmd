...
library(vistime) # create timelines
library(Amelia) # create missingness maps
library(wesanderson) # palettes from wes anderson movies for nerds
library(cowplot) # put plots side by side
