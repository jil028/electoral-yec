...
---
Purpose: to clean data and create figures in the thesis.
...
# figure: trend of turnout rates of elections in Hong Kong, 2011-2021----------
```{r}
############
# Figure 1 #
############
...
# source: HKU
# make sure to run lines 111 to 151 again before this
...
protests <-
  read_sf(glue("{source_dir}/event_v2/event.shp"))
